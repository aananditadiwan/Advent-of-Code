...
seedsListInput = (''.join(inputArray[0])).split(':')[1]
seedsListInput = (''.join(seedsListInput)).split(' ')
seedsListInput = ' '.join(seedsListInput).split()
for eachElement in range(0,len(seedsListInput)):
   seedsListInput[eachElement]=int(seedsListInput[eachElement])
